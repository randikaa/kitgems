      ...
      <div className="min-h-screen py-12 px-4 flex items-center justify-center">
        <div className="max-w-md w-full text-center">
          <div className="bg-gradient-to-br from-royal-blue/20 to-black border border-gold/20 rounded-lg p-8">
            ...
            <h2 className="text-2xl font-serif text-white mb-4">Account Created!</h2>
      ...
      <div className="max-w-md w-full">
        ...
        <div className="bg-gradient-to-br from-royal-blue/20 to-black border border-gold/20 rounded-lg p-8">
          ...
          <p className="mt-4 text-center text-white/40 text-xs">
            ...
            <Link href="/terms" className="text-gold hover:text-gold/80 transition">
              Terms of Service
            </Link>{' '}
            and{' '}
            <Link href="/privacy" className="text-gold hover:text-gold/80 transition">
              Privacy Policy
            </Link>
          </p>
        </div>
